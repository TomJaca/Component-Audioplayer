    ...
    class AudioPlayer extends HTMLElement {
      ...
      static get observedAttributes() {
        return [
          ...
          'title',
          // el tamaño de la barra de frecuencia
          'bar-width',
          // el tamaño del espacio entre las barras
          'bar-gap',
          // El porcentaje de los datos del búfer de frecuencia para representar
          // si el dataArray contiene 1024 puntos de datos, solo un porcentaje de los datos
          // ser usado para dibujar en el lienzo
          'buffer-percentage'
        ];
      }
      ...
      updateAudioAttributes(name, value) {
        ...
        // si el atributo se estableció explícitamente en la etiqueta del reproductor de audio
        // configurarlo de lo contrario eliminarlo
      ...
      updateFrequency() {
        ...
        // esta es una representación de pérdida de la frecuencia
        // algunos datos se pierden para ajustarse al tamaño del lienzo
        for (let i = 0; i < barCount; i++) {
          // obtener porcentaje de i valor
          const iPerc = Math.round((i * 100) / barCount);
          // ¿A qué se asigna el porcentaje i en los datos de frecuencia?
          const pos = Math.round((bufferSize * iPerc) / 100);
          const frequency = this.dataArray[pos];
          // valor de frecuencia en porcentaje
          const frequencyPerc = (frequency * 100) / 255;
          // valor porcentual de frecuencia en píxeles en relación con la altura del lienzo
          const barHeight = (frequencyPerc * this.canvas.height) / 100;
          // voltear la altura para que la barra se dibuje desde abajo
      ...
      render() {
        ...
        // Admite pantalla retina en lienzo para una apariencia más nítida/HD
        ...
        // si se deben restablecer todos los atributos de audio al renderizar o volver a renderizar
